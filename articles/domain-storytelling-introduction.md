...
「ドメイン知識 = 人々の会話の中に存在する」という考えに基づき、具体的な業務シナリオを絵に描くことで可視化します。
...
しかし、目の前で図が描かれていくと、「あれ？ そのタイミングではまだ在庫確認はできないよ」といった指摘が即座に出てきます。フィードバックループを高速に回せるのが大きなメリットです。
...
最終的に生成されたシーケンス図をNano banana Proで画像生成することでわかりやすい図として可視化することができます。


# やってみた

実際にAI活用して可視化するところまでやってみました。
今回は、
