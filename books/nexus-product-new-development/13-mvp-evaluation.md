...
| 用語 | 正式名称 | 説明 |
| :--- | :--- | :--- |
| DDD | Domain-Driven Design（ドメイン駆動設計） | 業務ドメインを中心に据えたソフトウェア設計手法。集約・値オブジェクト・境界コンテキストなどのパターンを使う |
...
Architectパイプラインでは、上記のMVPコード調査（40.5/100）とは別フェーズで、MMIとDDDをそれぞれ評価しました。
